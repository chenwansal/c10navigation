...
/***/ "./dst/UI/ToolWindow/ToolCardWindow.js":
/*!*********************************************!*\
  !*** ./dst/UI/ToolWindow/ToolCardWindow.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {

eval("\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nexports.ToolCardWindow = void 0;\r\nconst CommonUI_1 = __webpack_require__(/*! ../Common/CommonUI */ \"./dst/UI/Common/CommonUI.js\");\r\nclass ToolCardWindow {\r\n    constructor() {\r\n        this.name = \"tool-card-window\";\r\n    }\r\n    Render() {\r\n        // Create Section\r\n        let section = CommonUI_1.CommonUI.CreateSectionTitle(\"工具集\", __webpack_require__.g.APP);\r\n        // Create Root\r\n        let root = document.createElement(\"div\");\r\n        root.id = this.name;\r\n        root.className += this.name;\r\n        section.appendChild(root);\r\n        this.root = root;\r\n    }\r\n}\r\nexports.ToolCardWindow = ToolCardWindow;\r\n\n\n//# sourceURL=webpack://c10_navigation_web/./dst/UI/ToolWindow/ToolCardWindow.js?");
